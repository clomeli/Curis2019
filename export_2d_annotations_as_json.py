...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataroot', type=str, default='/mnt/c/Users/crist/Documents/Curis/data/sets/nuscenes', help="Path where nuScenes is saved.")
    ...
    print(osp.exists('/mnt/c/Users/crist/Documents/Curis/data/sets/nuscenes'))
    nusc = NuScenes(dataroot = args.dataroot)
    main(args)
